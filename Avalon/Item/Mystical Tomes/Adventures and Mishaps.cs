    ...
    public sealed class AdventuresAndMishapsSkill : SkillManager
    {
        ...
        public override void Activate(Player p)
        {
            ...
            for (double d = 0d; d < MathHelper.TwoPi; d += 0.2d)
                Main.projectile[Projectile.NewProjectile(p.Centre,
