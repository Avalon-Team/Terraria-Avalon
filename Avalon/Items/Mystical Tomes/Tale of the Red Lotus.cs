    ...
    public sealed class TaleOfTheRedLotusSkill : SkillManager
    {
        ...
        public override void Activate(Player p)
        {
            ...
            for (int i = 0; i < 13; i++)
            {
                ...
                Main.projectile[ExtendedSpawning.NewProj(p.Centre, new Vector2((float)Math.Cos(d) * -13f, (float)Math.Sin(d) * -13f), 45, (int)(35f * p.magicDamage), 1.1f, p.whoAmI)].timeLeft = 600;
            }
        }
    }
}
